...
\begin{figure}
	...
	\node[right=0.5em, draw, inner sep=0] (all) {\includegraphics[width=0.4\textwidth]{mrco_ico_scale_go1-0023.png}};
	\node[right=0.5em, draw, inner sep=0] at (all.east) (dyn) {\includegraphics[width=0.4\textwidth]{cgsd_2tau.png}};
	\matrix[%
