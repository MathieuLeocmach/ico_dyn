...
\begin{figure}
	...
	\begin{tikzpicture}[
		...
		\begin{axis}[%
			...
			\addplot+[only marks, fill=black] table[x index=0, y expr=\thisrowno{3}/0.135]{scale.xi};
			\addplot+[mark=none, forget plot, domain=0.49:0.58] {(0.6/x-1)^(-2.0/3.0)};
			\addplot+[only marks, fill=white] table[x index=0, y expr=\thisrowno{5}/0.216]{scale.xi};
