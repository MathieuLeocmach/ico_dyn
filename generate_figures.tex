...
\begin{figure}
	\begin{tikzpicture}[
		external/system call/.add={}{; gs -sOutputFile="\image"_gray.pdf -sDEVICE=pdfwrite -sColorConversionStrategy=Gray -dProcessColorModel=/DeviceGray -dCompatibilityLevel=1.4 "\image".pdf < /dev/null},%
