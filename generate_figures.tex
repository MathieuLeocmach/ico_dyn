...
\begin{figure}
	...
	\begin{tikzpicture}[
		...
		\begin{axis}[%
			...
			\addplot+[mark=none, dashed, forget plot, domain=0.49:0.58] {0.2009*(1-x/0.59773962)^(-2.0/3.0)};
...
\begin{figure}
	...
	\pgfplotsset{ every axis/.append style={ width=0.45\textwidth }}
	\begin{loglogaxis}[%
		...
		\node[above right,red] at (axis cs:100,100) {$x^{-2.1}$};
	...
	\begin{loglogaxis}[%
		...
		\node[left,red] at (axis cs:40,6) {$d_f=2$};
		\addplot+[no marks, domain=100:1000] {x^(1/3.)};
		\node[below right,brown] at (axis cs:100,5) {$d_f=3$};
		\addplot+[no marks, domain=20:30] {0.1*x};
		\node[below right,black] at (axis cs:30,3) {$d_f=1$};
...
\begin{figure}
	...
	\begin{loglogaxis}[%
		xlabel={$q$}, ylabel={$S_4(q,t|_{\chi_4\text{ max}})$},
		cycle list name=mark list,%
		xmin=0.2, xmax=10, ymin=0.1,%
		width=0.5\textwidth,%
		%legend columns=3, 
		legend pos=south west, reverse legend, legend style={font=\scriptsize}, %
		]
		\addplot+[blue, fitc] {0.66383233/(1+0.7612091^2*x^2)};
		\addplot+[blue, only marks] file {LS3954.S4};
		\addplot+[blue!30!gray, fitc] {0.76960902/(1+0.84605631^2*x^2)};
		\addplot+[blue!30!gray, only marks] file {LS4446.S4};
		\addplot+[gray, fitc] {0.79936805/(1+0.86763056^2*x^2)};
		\addplot+[gray, only marks] file {LS4582.S4};
		\addplot+[red!50!gray, fitc] {0.99838363/(1+1.00238391^2*x^2)};
		\addplot+[red!50!gray, only marks] file {LS5079.S4};
		\addplot+[red, fitc] {2.744/(1+1.802^2*x^2)};
