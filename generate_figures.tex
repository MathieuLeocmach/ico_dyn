...
\begin{figure}
	...
	\node[right=1em, draw, inner sep=0] (all) {\includegraphics[width=0.75\textwidth]{mrco_ico_scale_go1-0023.png}};
	\matrix[%
	...
	\node[above] at (l.north) (ico) {\includegraphics[width=0.2\textwidth]{one_ico.png}};
	\node at (ico.north){$w_6=w_6^*$};
	\node[below] at (l.south) (mrco) {\includegraphics[width=0.2\textwidth]{one_mrco.png}};
	\node at (mrco.south) {$Q_6=Q_6^*$};
	\node[lab, anchor=north, inner sep=0.2em] at (all.north) {$\phi=0.575$};
	\end{tikzpicture}
