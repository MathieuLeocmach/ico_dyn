...
\begin{figure}
	...
	%\draw [help lines, step=0.1\textwidth] (mrco.south west) grid (mrco.north east);
	\draw[arr] ($(mrco.south west)+(0.19\textwidth, 0.17\textwidth)$) -- ($(mrco.south west)+(0.19\textwidth, 0.32\textwidth)$);
	\draw[arr] ($(dyn.south west)+(0.19\textwidth, 0.17\textwidth)$) -- ($(dyn.south west)+(0.19\textwidth, 0.32\textwidth)$);
	\draw[arr] ($(mrco.south west)+(0.17\textwidth, 0.07\textwidth)$) -- ($(mrco.south west)+(0.43\textwidth, 0.23\textwidth)$);
	\draw[arr] ($(dyn.south west)+(0.17\textwidth, 0.07\textwidth)$) -- ($(dyn.south west)+(0.43\textwidth, 0.23\textwidth)$);
	\matrix[%
