...
\begin{figure}
	...
	\draw[arr] ($(mrco.south west)+(0.17\textwidth, 0.07\textwidth)$) -- ($(mrco.south west)+(0.37\textwidth, 0.19\textwidth)$);
	\draw[arr] ($(dyn.south west)+(0.17\textwidth, 0.07\textwidth)$) -- ($(dyn.south west)+(0.37\textwidth, 0.19\textwidth)$);
	\matrix[%
