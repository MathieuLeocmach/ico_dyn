...
\begin{figure}
	\begin{tikzpicture}
		...
		{Q4Q6go1};
		\node [anchor=north west, text height=0.8em, text depth=0.2em] at (rel axis cs:0,1) {\bf a};
		...
		{w4Q6go1};
		\node [anchor=north west, text height=0.8em, text depth=0.2em] at (rel axis cs:0,1) {\bf b};
		...
		{u6Q6go1_scale};
		\node [anchor=north west, text height=0.8em, text depth=0.2em] at (rel axis cs:0,1) {\bf c};
		...
		[xmin=-0.052,xmax=0.052,ymin=0,ymax=0.6]
		{u6Q6phi3954_scale};
		\node [anchor=north west, text height=0.8em, text depth=0.2em] at (rel axis cs:0,1) {\bf d};
...
\begin{figure}
	...
	\begin{tikzpicture}[%
		...
		lab/.style={below left=0.005\textwidth, text height=0.8em, text depth=0.2em}%
		]
	...
	\node[left=0.01\textwidth, pic3d] at (dyn.west) (mrco) {\includegraphics[width=0.48\textwidth]{mrco_scale_go1.png}};
	\matrix[%
	...
	\node [lab] at (one_ico.north east) {\bf a};
	\node [lab] at (one_mrco.north east) {\bf b};
	\node [lab] at (all.north east) {\bf c};
	\node [lab] at (mrco.north east) {\bf d};
	\node [lab] at (dyn.north east) {\bf e};
	\end{tikzpicture}
