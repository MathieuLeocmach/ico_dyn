...
\begin{figure}
	...
	\begin{tikzpicture}[%
		...
		lab/.style={below left=0.4em and 0, inner sep=0, text height=0.8em, text depth=0.2em, font=\Large\bfseries},%
	...
	\matrix[%
		above left=0.01\textwidth of pic-1-1.south east, font=\footnotesize,% 
