...
\begin{equation}
	\Delta r^2(w_6, t) \equiv \left\langle \frac{
		\sum\limits_i{
			\left\|\mathbf{r_i}(t)-\mathbf{r_i}(0)\right\|^2 \delta(w_6^i-w_6)
			}
	}{
...
\begin{equation}
	...
	\label{eq:Mu}
\end{equation}
where ${\Delta r^2}_i(t) = \left\|\mathbf{r_i}(t)-\mathbf{r_i}(0)\right\|^2$ and the neighbours are defined at initial time. 
