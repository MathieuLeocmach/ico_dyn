...
\textcolor{blue}{We emphasize that crystal-like bond orientational order is `not' crystal nuclei with solid nature, but transient medium-range structural order formed in a liquid (see below)}. 
